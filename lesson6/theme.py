# Azure theme for ttk, https://github.com/rdbende/Azure-ttk-theme
...
class Menu(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        menu_button1.grid(row=0, column=0, columnspan=2, sticky="nsew", padx=5, pady=5)
...
App("Class-Based Application", (1000, 1000))
